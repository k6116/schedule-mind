...
# handle arguments passed from the controller
jsObj = ast.literal_eval(sys.argv[1])
...
def solve_shift_scheduling(params, output_proto):
    ...
    # Data
    num_employees = int(jsObj['numOfEmployees'])
    num_weeks = int(jsObj['numOfWeeks'])
    # num_employees = 5
    # num_weeks = 2
    shifts = ['O', 'M', 'A', 'N']
    ...
    weekly_cover_demands = jsObj['shiftRequirements']
